...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(item.itemId == R.id.shopping_cart){
            ...
            this.findNavController(R.id.my_nav_host_fragment).navigate(R.id.shopping_cart_dest, null, navOptions)
        }
    ...
    override fun onSupportNavigateUp(): Boolean {
        return this.findNavController(R.id.my_nav_host_fragment).navigateUp(appBarConfiguration)
    }
}
